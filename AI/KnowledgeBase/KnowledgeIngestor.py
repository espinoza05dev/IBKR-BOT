...
class KnowledgeIngestor:
    ...
    def __init__(self, collection: str = "trading_knowledge"):
        from AI.KnowledgeBase.VectorStore import VectorStore
        from AI.KnowledgeBase.Processors.TextProcessor  import TextProcessor
        from AI.KnowledgeBase.Processors.AudioProcessor import AudioProcessor
        from AI.KnowledgeBase.Processors.Videoprocessor import VideoProcessor
        from AI.KnowledgeBase.Processors.Imageprocessor import ImageProcessor
